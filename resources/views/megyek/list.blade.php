                        ...
                        <table class="table table-striped">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th>Művelet&nbsp;
                                        <a href="{{route('createMegyek')}}"><i class="fa fa-plus" title={{ __("ÚJ") }}>+</i></a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach($entities as $entity)
                                <tr>
                                    ...
                                    <td style="display: flex">
                                        ...
                                        <form method="post" action="{{ route('deleteMegyek', $entity->id) }}"><button class="btn btn-sm" type="submit"><i class="fa fa-trash">Töröl</i></button>
                                            @csrf
                                            @method('delete')
                                        </form>
